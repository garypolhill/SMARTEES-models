...
globals[month year initial-year plot-highlight scenario1-event scenario3-event1 scenario3-event2 scenario3-event3 csv-info]
breed [humats humat]
...
breed [scenario2c-managers scenario2c-manager] ;meetings manager for scenario 2C
...
humats-own[
  ...
  wellness-satisfaction-B
  environmental-quality-satisfaction-B
  comfort-satisfaction-B
  ...
  city-council-trust
  local-media-trust
  merchants-associations-trust
  other-associations-trust
  original-local-media-trust
  original-merchants-associations-trust
  original-other-associations-trust
...
to setup-landscape
  ...
  Make-Terrain
  ;ask patches [
    ;if  member? district-id ["0105901030" "0105901029" "0105901025" "0105901027" "0105901026" "0105903001" "0105903023" "0105901021" "0105901019" "0105901023" "0105901004" "0105901003" "0105901005" "0105901008" "0105903025" "0105903026" "0105902006" "0105902005" "0105901001" "0105901010" "0105902003" "0105902001" "0105901012" "0105901014" "0105901017" "0105901013" "0105901015" "0105901018" "0105904001" "0105904002" "0105904004" "0105904008" "0105904009" "0105904007" "0105901018" "0105901016" "0105904003" "0105901009" "0105901011" "0105901002" "0105901020" "0105901022" "0105901024" "0105901028" "0105903024" "0105901007"][
      ;set pcolor 1.0
    ;]
  ;]
...
to Update-Social-Satisfaction
  ask humats[
    carefully[
      ...
      set satisfaction-A (wellness-evaluation-A + social-evaluation-A + environmental-quality-evaluation-A + comfort-evaluation-A + prestige-evaluation-A + participation-evaluation-A) / 6
      set satisfaction-B (wellness-evaluation-B + social-evaluation-B + environmental-quality-evaluation-B + comfort-evaluation-B + prestige-evaluation-B + participation-evaluation-B) / 6
...
to Compare-Experiential-Needs
  (ifelse Further-Comparison-Needed?  wellness-evaluation-A  wellness-evaluation-B 2 [Choose-Randomly]
   [ifelse  wellness-evaluation-A >  wellness-evaluation-B
     [set behavior "A" set satisfaction satisfaction-A set color green ]
     [set behavior "B" set satisfaction satisfaction-B set color red]
   ]
  )
...
ifelse behavior = "A"
  [set satisfaction satisfaction-A set color green ]
  [set satisfaction satisfaction-B set color red]
...
to go
  ...
  ;Catastrophic-Event
  ;let tramo = count humats with [wellness-satisfaction-A > -1 and wellness-satisfaction-A < 0.05]
  ...
  set csv-info lput (list count humats with [behavior = "A"] count humats with [behavior = "B"] comm ) csv-info
  if month = 6 and year = 2013[
    export-plot "Wellness Satisfaction" (word "was"  run-number  ".csv")
    export-plot "Environmental-Quality Satisfaction" (word "eqas"  run-number  ".csv")
    export-plot "Social Satisfaction" (word "sas"  run-number  ".csv")
    export-plot "Comfort Satisfaction" (word "cas"  run-number  ".csv")
    export-plot "Prestige Satisfaction" (word "peas"  run-number  ".csv")
    export-plot "Participation Satisfaction" (word "pas"  run-number  ".csv")
  ]

  if month = 5 and year = 2021[
    ;export-plot "Wellness Satisfaction" (word "wac"  run-number  ".csv")
    ...
    ;export-plot "Comfort Satisfaction" (word "cac"  run-number  ".csv")
...
to Inquire
  ask humats [
    ...
    if dissonance-strength > 0 and (wellness-dilemma? = 1 or environmental-quality-dilemma? = 1 or comfort-dilemma? = 1 or prestige-dilemma? = 1 or participation-dilemma? = 1)  [
      Inquire-Comm
    ]
  ]
end
...
to Update-Dissonances
  ...
  set wellness-dilemma? 0
  set social-dilemma? 0
  set environmental-quality-dilemma? 0
  set comfort-dilemma? 0
  set prestige-dilemma? 0
  set participation-dilemma? 0

  ;get evaluations list for the Dissatisfying-Status-BA function
  let evaluations-list-A (list social-evaluation-A wellness-evaluation-A environmental-quality-evaluation-A comfort-evaluation-A prestige-evaluation-A participation-evaluation-A)
  ...
  ;get evaluations list for the Dissatisfying-Status-BA function
  let evaluations-list-B (list social-evaluation-B wellness-evaluation-B environmental-quality-evaluation-B comfort-evaluation-B prestige-evaluation-B participation-evaluation-B)
  ...
  [
    ...
    ;wellness dilemma
    if (wellness-evaluation-A > 0 and environmental-quality-evaluation-A < 0 and comfort-evaluation-A < 0 and prestige-evaluation-A < 0 and participation-evaluation-A < 0 and social-evaluation-A < 0)  or
    (wellness-evaluation-A < 0 and environmental-quality-evaluation-A > 0 and comfort-evaluation-A > 0 and prestige-evaluation-A > 0 and participation-evaluation-A > 0 and social-evaluation-A > 0)
    [set wellness-dilemma? 1]
    ;environmental quality dilemma
    if (wellness-evaluation-A < 0 and environmental-quality-evaluation-A > 0 and comfort-evaluation-A < 0 and prestige-evaluation-A < 0 and participation-evaluation-A < 0 and social-evaluation-A < 0)  or
    (wellness-evaluation-A > 0 and environmental-quality-evaluation-A < 0 and comfort-evaluation-A > 0 and prestige-evaluation-A > 0 and participation-evaluation-A > 0 and social-evaluation-A > 0)
  ...
  [
    ...
    ;wellness dilemma
    if (wellness-evaluation-B > 0 and environmental-quality-evaluation-B < 0 and comfort-evaluation-B < 0 and prestige-evaluation-B < 0 and participation-evaluation-B < 0 and social-evaluation-B < 0)  or
    (wellness-evaluation-B < 0 and environmental-quality-evaluation-B > 0 and comfort-evaluation-B > 0 and prestige-evaluation-B > 0 and participation-evaluation-B > 0 and social-evaluation-B > 0)
    [set wellness-dilemma? 1]
    ;environmental quality dilemma
    if (wellness-evaluation-B < 0 and environmental-quality-evaluation-B > 0 and comfort-evaluation-B < 0 and prestige-evaluation-B < 0 and participation-evaluation-B < 0 and social-evaluation-B < 0)  or
    (wellness-evaluation-B > 0 and environmental-quality-evaluation-B < 0 and comfort-evaluation-B > 0 and prestige-evaluation-B > 0 and participation-evaluation-B > 0 and social-evaluation-B > 0)
...
800
population-csv
/BasesDeDatos/CensoPobleNou.csv
1
0
String
...
"" ""
PENS
"Accept" 0.05 0 -14439633 true "" "histogram [wellness-satisfaction-A] of humats"
"Importance" 0.05 1 -14454117 true "" "histogram [wellness-importance] of humats"
"Reject" 0.05 0 -5298144 true "" "histogram [wellness-satisfaction-B] of humats"
...
"" ""
PENS
"Accept" 0.05 0 -14439633 true "" "histogram [comfort-satisfaction-A] of humats"
"Importance" 0.05 1 -14454117 true "" "histogram [comfort-importance] of humats"
"Reject" 0.05 0 -5298144 true "" "histogram [comfort-satisfaction-B] of humats"
...
"" ""
PENS
"Communication" 1.0 0 -16777216 true "" "if plot-highlight = 0 [\nset-plot-pen-color black\nplot (count humats with [inquiring = 1] + count humats with [signaling = 1] + count humats with [random-conv = 1] + sum [meeting-conv] of humats)\n]\nif plot-highlight = 1 [\nset-plot-pen-color red\nplot (count humats with [inquiring = 1] + count humats with [signaling = 1] + count humats with [random-conv = 1] + count humats with [meeting-conv > 0])\n]"
...
setup</setup>
    ...
    <enumeratedValueSet variable="csv-name">
      <value value="&quot;ejecución1.csv&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="population-csv">
      <value value="&quot;/BasesDeDatos/BDDistrVitoriaNetlogo&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="mod-pos-curve">
      <value value="-0.16"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="critical-nodes-config">
      <value value="&quot;CriticalNodeVitoria.csv&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="mod-curve">
      <value value="0.24"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="trust-reduction-scenario1">
      <value value="0.2"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="scenario3-comm-prob-late">
      <value value="0.010485760000000005"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="experimentos" repetitions="1" runMetricsEveryStep="true">
    <setup>setup-landscape
setup-citizens
setup-social-network
setup</setup>
...
setup</setup>
    ...
    <enumeratedValueSet variable="population-csv">
      <value value="&quot;/BasesDeDatos/CensoPobleNou.csv&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="critical-nodes-config">
      <value value="&quot;CriticalNodeBarcelona.csv&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="mod-pos-curve">
      <value value="-0.15"/>
    </enumeratedValueSet>
...
setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="meeting-comm-prob">
      <value value="0.05"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="meeting-comm-prob-late">
      <value value="0.04000000000000001"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="social-reach">
      <value value="1"/>
    </enumeratedValueSet>
  ...
  <experiment name="Escenario3" repetitions="1" runMetricsEveryStep="true">
    <setup>setup-landscape
setup-citizens
setup-social-network
setup</setup>
...
setup</setup>
    ...
    <enumeratedValueSet variable="meeting-comm-prob-late">
      <value value="0.016384000000000006"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="social-reach">
      <value value="1"/>
    </enumeratedValueSet>
  ...
  <experiment name="Scenario1" repetitions="1" runMetricsEveryStep="true">
    <setup>setup-landscape
setup-citizens
setup-social-network
setup</setup>
  ...
  <experiment name="Escenario3-Corto" repetitions="1" runMetricsEveryStep="true">
    <setup>setup-landscape
setup-citizens
setup-social-network
setup</setup>
  ...
  <experiment name="scenario-2c" repetitions="1" runMetricsEveryStep="true">
    <setup>setup-landscape
setup-citizens
setup-social-network
setup</setup>
    ...
    <enumeratedValueSet variable="scenario-2C">
      <value value="true"/>
    </enumeratedValueSet>
  </experiment>
